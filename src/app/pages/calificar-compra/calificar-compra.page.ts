...
export class CalificarCompraPage implements OnInit {
  ...
  calificar() {
    if (this.validarTexto() && this.validarValoracionProductos()) {
      ...
      const url = 'http://www.feriasclick.escuela-fundacion-sol.cl/ferias/registro.php?opcion=26';
      ...
      this.data.subscribe(data => {
        if (data === true) {
          ...
          this.productosEvaluados.forEach(prodEva => {
            const urlDos = 'http://www.feriasclick.escuela-fundacion-sol.cl/ferias/registro.php?opcion=27';
          ...
          const urlTres = 'http://www.feriasclick.escuela-fundacion-sol.cl/ferias/registro.php?opcion=28';
  ...
  obtenerProductos() {
    ...
    const url = 'http://www.feriasclick.escuela-fundacion-sol.cl/ferias/registro.php?opcion=25';
    const postData = new FormData();
