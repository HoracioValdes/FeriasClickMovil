...
export class ConfirmacionCompraPage implements OnInit {
  ...
  hacerPago() {
    ...
    const url = 'http://www.feriasclick.escuela-fundacion-sol.cl/ferias/registro.php?opcion=4';
    ...
    this.data.subscribe(data => {
      if (data === true) {
        ...
        const urlDos = 'http://www.feriasclick.escuela-fundacion-sol.cl/ferias/registro.php?opcion=5';
        ...
        this.dataDos.subscribe(dataDos => {
          ...
          if (dataDos.length >= 1) {
            ...
            for (const producto of this.listaProductos) {
              const urlTres = 'http://www.feriasclick.escuela-fundacion-sol.cl/ferias/registro.php?opcion=6';
              ...
              this.dataTres.subscribe(dataTres => {
                if (dataTres === true) {
                  ...
                  const urlCuatro = 'http://www.feriasclick.escuela-fundacion-sol.cl/ferias/registro.php?opcion=7';
                  ...
                  this.dataCuatro.subscribe(dataCuatro => {
                    ...
                    if (dataCuatro.length >= 1) {
                      ...
                      const urlCinco = 'http://www.feriasclick.escuela-fundacion-sol.cl/ferias/registro.php?opcion=8';
