...
@Component({
  selector: 'app-carga-imagen-perfil-repartidor',
  templateUrl: './carga-imagen-perfil-repartidor.page.html',
  styleUrls: ['./carga-imagen-perfil-repartidor.page.scss'],
})
export class CargaImagenPerfilRepartidorPage implements OnInit {
