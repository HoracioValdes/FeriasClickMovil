...
export class CompradorPage implements OnInit {
  ...
  obtenerProductos() {
    // Consulta de productos
    const url = 'http://www.feriasclick.escuela-fundacion-sol.cl/ferias/registro.php?opcion=1';
  ...
  obtenerDespachos() {
    // Consulta de despachos
    const url = 'http://www.feriasclick.escuela-fundacion-sol.cl/ferias/registro.php?opcion=24';
    const postData = new FormData();
    // Agrego datos a la consulta
